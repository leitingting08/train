...
<style lang="less">
@yellow:#FFC300;
.time-calender{background: @yellow;width: 100%;padding: 0.1rem 0;margin-top: -0.05rem;
   .flex-demo{text-align: center;i{padding:0 0.2rem;}}
   .l{text-align: left;}
   .c{background: #fff;padding:0.15rem 0;}
   .r{text-align: right;}
}
</style>