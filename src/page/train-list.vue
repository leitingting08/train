         ...
         <div class="lists">
            <div class="list">
                <flexbox>
                    ...
                    <flexbox-item><div class="flex-demo c1"><span>G34</span><br/><span>5时55分</span></div></flexbox-item>
...
.train-list{
    ...
    .time-calender{position: fixed;top: 0.9rem;width: 100%;z-index: 100;}
  .lists{position: absolute;top: 1.7rem;width: 100%;
