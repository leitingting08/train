...
<div class="book-ticket">
   <vTitle></vTitle>
    ...
    <cell class="comT" is-link><span slot="title"><i class="fa fa-ticket fa-2"></i>
    	<div style="margin-left:0.5rem;"><span class="font30">{{('没票？试试上车补票吧！')}}</span><br/><span class="col999 font20">{{('购买中途站车票，上车再补票')}}</span></div></span></cell>
</div>
</template>
...
export default{
	components:{vTitle,Flexbox, FlexboxItem,timeCalender,XTable,Cell},
	data (){
		return{
			title:'12月25日 周一'
		}
