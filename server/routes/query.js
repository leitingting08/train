...
router.get("/query", function(req,res,next){
    const obj = req.body;
    const url = '/otn/leftTicket/query?leftTicketDTO.train_date=2018-08-17&leftTicketDTO.from_station=HZH&leftTicketDTO.to_station=MCN&purpose_codes=ADULT';
    const options = {
...
// const date = readlineSync.question('出发日期(2018-08-12):');
