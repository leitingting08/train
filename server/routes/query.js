...
const date = readlineSync.question('出发日期(2018-04-28):');

async function getStations() {
  try {
    const result = await request('https://kyfw.12306.cn/otn/resources/js/framework/station_name.js?station_version=1.9051');
