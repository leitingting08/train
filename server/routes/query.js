...
router.post("/", function (req, res, next) {
  ...
  const url = 'https://kyfw.12306.cn/otn/leftTicket/query?leftTicketDTO.train_date=' + config.time + '&leftTicketDTO.from_station=' + config.from_station + '&leftTicketDTO.to_station=' + config.end_station + '&purpose_codes=' + config.passergerType
